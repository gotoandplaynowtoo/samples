...
public class Main extends JFrame
{
	...
	public Main()
	{
		setTitle("Circular Motion With Roll Over");
...
class MainPanel extends JPanel implements Runnable
{
	...
	public boolean isRolledOver = false;
	...
	private class MainPanelMouseListener extends MouseAdapter {
		...
		public void mouseMoved(MouseEvent e) {
			checkRollOver(e.getX(), e.getY());
		}

		public void checkRollOver(int x, int y) {
			double dx = 0, dy = 0;
			double dist = 0;
			for(Ball ball: balls) {

				if(ball.ball.contains(x,y))
				{
					isRolledOver = true;
					break;
				}
	...
	public MainPanel()
	{
		...
		addMouseMotionListener(new MainPanelMouseListener());
